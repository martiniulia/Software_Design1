...
namespace Software_Design1.Migrations
{
    ...
    [Migration("20260321135326_AddAssignedFloristToOrders")]
    partial class AddAssignedFloristToOrders
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FlowerShop.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        ...
                        .HasColumnType("int");
                    MySqlPropertyBuilderExtensions.UseMySqlIdentityColumn(b.Property<int>("Id"));
                    b.Property<int?>("AssignedFloristId")
                        .HasColumnType("int");
                    b.Property<int?>("BouquetId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FlowerShop.Models.Order", b =>
                {
                    b.HasOne("FlowerShop.Models.Florist", "AssignedFlorist")
                        .WithMany()
                        .HasForeignKey("AssignedFloristId")
                        .OnDelete(DeleteBehavior.SetNull);
                    b.HasOne("FlowerShop.Models.Bouquet", "Bouquet")
                        .WithMany("Orders")
                        .HasForeignKey("BouquetId");
